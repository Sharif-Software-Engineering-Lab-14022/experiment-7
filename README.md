...
- بازگردانی خودکار (Self-healing): در صورتی که یک container یا نود از کار بیفتد، Kubernetes به طور خودکار آن را مجدداً راه‌اندازی می‌کند یا جایگزین می‌نماید.
...
استفاده از Docker برای ساخت containerها: Docker ابزاری است که developerها از آن برای بسته‌بندی برنامه‌ها و وابستگی‌های آن‌ها در یک واحد قابل حمل به نام container استفاده می‌کنند.
...
همکاری و هماهنگی: با وجود تغییرات اخیر، هنوز هم بسیاری از ابزارها و پروژه‌های مبتنی بر containerه از Docker برای ساخت و توسعه استفاده می‌کنند، و سپس Kubernetes برای مدیریت و استقرار آن‌ها به کار می‌رود.
